...
export class PuppeteerNode extends Puppeteer {
    ...
    get _launcher() {
        if (!__classPrivateFieldGet(this, _PuppeteerNode_launcher, "f") ||
            ...
            __classPrivateFieldSet(this, _PuppeteerNode_launcher, createLauncher(this._preferredRevision, this._isPuppeteerCore, this._productName), "f");
        }
...
_PuppeteerNode_launcher = new WeakMap(), _PuppeteerNode_productName = new WeakMap();
