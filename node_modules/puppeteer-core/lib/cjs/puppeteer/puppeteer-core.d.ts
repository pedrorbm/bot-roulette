...
createBrowserFetcher: (options: import("./node/BrowserFetcher.js").BrowserFetcherOptions) => import("./node/BrowserFetcher.js").BrowserFetcher, defaultArgs: (options?: import("./types.js").BrowserLaunchArgumentOptions) => string[], executablePath: (channel?: string | undefined) => string, launch: (options?: import("./node/PuppeteerNode.js").PuppeteerLaunchOptions) => Promise<import("./types.js").Browser>;
