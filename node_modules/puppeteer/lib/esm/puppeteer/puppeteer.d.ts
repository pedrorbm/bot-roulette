...
export declare const connect: (options: import("puppeteer-core/internal/common/Puppeteer.js").ConnectOptions) => Promise<import("./types").Browser>, 
/** @deprecated Import {@link BrowserFetcher} directly and use the constructor. */
createBrowserFetcher: (options: import("puppeteer-core/internal/node/BrowserFetcher.js").BrowserFetcherOptions) => import("puppeteer-core/internal/node/BrowserFetcher.js").BrowserFetcher, defaultArgs: (options?: import("puppeteer-core/internal/node/LaunchOptions.js").BrowserLaunchArgumentOptions | undefined) => string[], executablePath: (channel?: string | undefined) => string, launch: (options?: import("puppeteer-core/internal/node/PuppeteerNode.js").PuppeteerLaunchOptions | undefined) => Promise<import("./types").Browser>;
